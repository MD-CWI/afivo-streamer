...
p.add_argument('-field_file', type=str, default='2.5e6_0.5e6_15e-3_60e-3.txt', help='Output file name')
args = p.parse_args()
...
np.savetxt(args.field_file, np.array([0.08-length, eField]).T, header=head, footer='---------------', comments='')
...
plt.plot(80-length, eField, label='2.5e6_0.5e6_15e-3_60e-3', color='red', linestyle='-', linewidth=2, marker='D', markersize=0)
...
plt.savefig('2.5e6_0.5e6_15e-3_60e-3.jpg')
plt.show()
