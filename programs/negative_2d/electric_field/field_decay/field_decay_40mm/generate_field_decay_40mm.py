...
p.add_argument('-field_file', type=str, default='field_decay.txt', help='Output file name')
args = p.parse_args()
...
np.savetxt(args.field_file, np.array([0.04-length, eField]).T, header=head, footer='---------------', comments='')
...
plt.plot(40-length, eField, label='Electric field', color='red', linestyle='-', linewidth=2, marker='D', markersize=0)
