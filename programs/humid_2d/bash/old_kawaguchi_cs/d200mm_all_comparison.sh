...
./streamer d200mm_0.10H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/starikovskiy_0.10H2O_Kawaguchi.txt -photoi_helmh%author="Bourdon-3" -output%name=/export/scratch2/baohong/humid_air/comparison/starikovskiy_0.9e6_0.10H2O_Bourdon
./streamer d200mm_0.10H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/starikovskiy_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/starikovskiy_0.9e6_0.10H2O_Aints
./streamer d200mm_0.10H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/starikovskiy_0.10H2O_Kawaguchi.txt -photoi_helmh%coeffs="6.97075E+08  8.58360E+04  3.82738E+06" -photoi_helmh%lambdas="3.30404E+04  2.83311E+03  5.18507E+03" -output%name=/export/scratch2/baohong/humid_air/comparison/starikovskiy_0.9e6_0.10H2O_Naidis

./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/starikovskiy_0.03H2O_Kawaguchi.txt -photoi_helmh%author="Bourdon-3" -output%name=/export/scratch2/baohong/humid_air/comparison/starikovskiy_0.9e6_0.03H2O_Bourdon


./streamer d200mm_0.00H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/baohong_0.00H2O_Phelps.txt -output%name=/export/scratch2/baohong/humid_air/comparison/baohong_0.9e6_0.00H2O_Bourdon
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/malagon_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/malagon_0.9e6_0.03H2O_Aints
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/komuro_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/komuro_0.9e6_0.03H2O_Aints
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/starikovskiy_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/starikovskiy_0.9e6_0.03H2O_Aints


./streamer d200mm_0.00H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/baohong_0.00H2O_Phelps.txt -output%name=/export/scratch2/baohong/humid_air/comparison/baohong_0.9e6_0.00H2O_Bourdon_rmd5e-6
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/malagon_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/malagon_0.9e6_0.03H2O_Aints_rmd5e-6
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/komuro_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/komuro_0.9e6_0.03H2O_Aints_rmd5e-6
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/starikovskiy_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/starikovskiy_0.9e6_0.03H2O_Aints_rmd5e-6
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/malagon_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/malagon_0.9e6_0.03H2O_Aints_rmd5e-6_narrow -domain_len="0.1 0.2"

./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/malagon_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/malagon_0.9e6_0.03H2O_Aints_rmd1e-6_cgs64 -refine_min_dx=1e-6 -coarse_grid_size="64 64"
./streamer d200mm_0.03H2O.cfg -field_given_by="field -0.9e6" -input_data%file=../../transport_data/humid_air/malagon_0.10H2O_Kawaguchi.txt -output%name=/export/scratch2/baohong/humid_air/comparison/malagon_0.9e6_0.03H2O_Aints_rmd3e-6_cgs64 -refine_min_dx=3e-6 -coarse_grid_size="64 64"
