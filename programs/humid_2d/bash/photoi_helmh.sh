...
echo "-----------------Moist air, 20% water, fit with Naidis curve from literature"
./absorption_function.py -gases O2 H2O -pressures 0.16 0.2 -n_modes 3 -fit_range $fit_range -fit_type log -show_curve $bourdon_fit -show_Zheleznyak -show_Naidis_moist -show_Aints_moist