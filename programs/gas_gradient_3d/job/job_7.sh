...
./streamer d10mm_3d_new.cfg -field_given_by="field -1.6e6" -density_ratio=2.2 -shock_width=0.015 -line_coeff="0.5 0 0 -1" -output%name=/scratch-shared/baohongg/3d_line/line0.5-z_1.6e6_dr2.2_sw0.015 &
