...
if __name__ == '__main__':
    ...
    #np.savetxt(args.output, np.column_stack([it_values, var_values]), header = 'it Est delta_phi phi_head phi_tail L head_x head_y head_z tail_x tail_y tail_z', comments = '', delimiter = '', fmt = ['%d'] + ['%.8e']*11)
