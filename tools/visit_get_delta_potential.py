...
if __name__ == '__main__':
    ...
    np.savetxt(args.output, np.column_stack([it_values, time_values, var_values]), header = 'it time delta_phi phi_current phi_background x y z', comments = '', delimiter = '', fmt=''.join(['%3d'] + ['%17.8e']*7))
