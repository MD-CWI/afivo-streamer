...
def get_argparser():
    ...
    pr = argparse.ArgumentParser(
        ...
        database variable -r0 x0 y0 z0 -r1 x1 y1 z1 -r pt''',
...
if __name__ == '__main__':
    ...
    np.savetxt('point_y_'+str(args.r)+'m_'+args.varname+'_vs_time.txt', np.vstack([t_values, var_values]).T, header = "time "+args.varname, comments = '')
